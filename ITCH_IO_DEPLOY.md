...
- `flylife-itch-full.zip`: full static game hosted by itch.io. Leaderboards and official Fly submissions still use the Flyrace Netlify API automatically.
...
```powershell
$env:FLYLIFE_ITCH_URL="https://flyrace.netlify.app/?itchStatus=1"
npm run package:itch
```
...
No itch.io environment variables are required. Flyrace Netlify still owns the official leaderboard API.
